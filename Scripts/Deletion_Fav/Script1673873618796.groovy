...
WebUI.setText(findTestObject('Object Repository/Give_Score_And_Add_Fav/input_Log out_search-field'), 'One piece')
...
WebUI.click(findTestObject('Object Repository/Deletion_Fav/button_-'))
